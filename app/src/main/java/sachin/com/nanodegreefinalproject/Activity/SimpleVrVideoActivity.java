...
/*Eg Intent :-> adb shell am start -a android.intent.action.VIEW  -n sachin.com.nanodegreefinalproject/.Activity.SimpleVrVideoActivity  -d " https://r3---sn-hu
        oa-qxal.googlevideo.com/videoplayback?mime=video%2Fmp4&pl=20&ip=59.178.160.201&expire=1487220173&ms=au&source=youtube&dur=160.310&mv=m&id=o-AGFY4vRvuG37eLh6uw2pOm6lJGkTUVYdIulKn4iLZN
        tv&key=yt6&mm=31&ipbits=0&mn=sn-huoa-qxal&initcwndbps=232500&mt=1487198547&upn=eg3m5tS2Sic&sparams=dur%2Cid%2Cinitcwndbps%2Cip%2Cipbits%2Citag%2Clmt%2Cmime%2Cmm%2Cmn%2Cms%2Cmv%2Cpl%2
        Cratebypass%2Crequiressl%2Csource%2Cupn%2Cexpire&requiressl=yes&lmt=1479853203652764&itag=18&signature=44A218E8D2238ACD018339DEEF2C048B03060153.651D4488080B51C6C61EEBBCA49DAEB4B9F9D1
        2A&ratebypass=yes"  --ei inputType 1*/
...
private TextView mSignInTextView;
  ...
  public void onCreate(Bundle savedInstanceState) {
   ...
   /* TextView sourceText = (TextView) findViewById(R.id.source);
    ...
    if(SharedPrefs.getUserLoggedIn(this)){

      Intent next = new Intent(SimpleVrVideoActivity.this,MainActivity.class);
      startActivity(next);
      finish();
    ...
    mCreateAccountButton = (Button)findViewById(R.id.create_acc_buttonView);
    mSignInTextView = (TextView)findViewById(R.id.sign_in_textView);

    mCreateAccountButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Intent next = new Intent(SimpleVrVideoActivity.this, LoginActivity.class);
        next.putExtra("type","Create Account");
        startActivity(next);
      }
    });
